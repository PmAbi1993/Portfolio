...
export function WindowManager() {
    ...
    return (_jsx(_Fragment, { children: sorted.map((w) => {
            return (_jsxs(Window, { win: w, children: [w.appType === 'finder' && _jsx(FinderAboutMe, {}), w.appType === 'settings' && _jsx(SettingsWindow, {}), w.appType === 'project' && (_jsx(ProjectWindow, { project: w.payload.project }))] }, w.id));
        }) }));
}
